<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Following.aspx.cs" Inherits="BTL_LTWeb.Following" %>
...
<body>
       ...
       <main>
        <div class="left">
            <div class="btns">
                ...
                <a href="HomeUserLogined.aspx"><i class="fas fa-video"></i><span>Live</span></a>
            </div>
   ...
   <div class="right">
        <div class="box">
            <h3>Popular Creators List</h3>
                        <asp:ListView ID="listfollow" runat="server">
                        <ItemTemplate>
                           <div class="list">
                            <div class="imgBox">
                                ...
                                <div class="content">
                                    <h2 class="rank"> <button class="huyfollow">Hủy Follow</button></h2>
                                    <h4><%# Eval("Name") %></h4>
                                </div>
                            </div>
                       </ItemTemplate>
